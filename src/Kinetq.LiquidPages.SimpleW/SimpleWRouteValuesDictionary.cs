...
public sealed class SimpleWRouteValuesDictionary : IReadOnlyRouteValuesDictionary
{
    private readonly IEnumerable<KeyValuePair<string, string>> _routeValues;

    public SimpleWRouteValuesDictionary(IEnumerable<KeyValuePair<string, string>> routeValues) => _routeValues = routeValues;
